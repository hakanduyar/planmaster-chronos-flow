      ...
      <div className="w-full max-w-none px-6 lg:px-12">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white/5 backdrop-blur-md border border-white/10 p-8 md:p-16 rounded-3xl text-center relative overflow-hidden"
          >
            {/* Background decoration */}
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600/5 via-blue-600/5 to-pink-600/5" />
            ...
            <div className="relative z-10">
              ...
              >
                <Link to="/register">
                  ...
                  >
                    <Button className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white px-8 py-4 md:px-12 md:py-6 text-xl font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 group">
                      Ücretsiz Başla
